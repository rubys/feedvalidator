    ...
    if url or rawdata:
        ...
        if goon:
            ...
            if msc != Error:
                ...
                print applyTemplate('valid.tmpl', {"url":htmlUrl, "srcUrl":htmlUrl, "feedType":FEEDTYPEDISPLAY[feedType], "graphic":VALIDFEEDGRAPHIC[feedType], "HOMEURL":HOMEURL, "docType":docType})
    else:
